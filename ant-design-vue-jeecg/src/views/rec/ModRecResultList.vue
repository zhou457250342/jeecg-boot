<template>
  <a-card :bordered="false">
    ...
    <div>
      ...
      >
        <span slot="statusText" slot-scope="statusText" style="color:red">{{ statusText }}</span>
        ...
        <template slot="action" slot-scope="text, record">
          <router-link :to="{ path: '/rec/detail', params: { id: record.tradeNo } }">
            详细信息
          </router-link>
        </template>
...
export default {
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          title: '主系统金额',
          align: 'center',
          dataIndex: 'amountMain'
        },
        {
          title: '支付系统金额',
          align: 'center',
          dataIndex: 'amountSide'
        },
        {
          title: '对账结果',
          align: 'center',
  ...
  methods: {
    ...
    getSuperFieldList() {
      ...
      fieldList.push({ type: 'BigDecimal', value: 'amountMain', text: '主系统金额', dictCode: '' })
      fieldList.push({ type: 'BigDecimal', value: 'amountSide', text: '支付系统金额', dictCode: '' })
